...
public class GuardiasIncumplidas extends JFrame {
	...
	public GuardiasIncumplidas(boolean oscuro, Color fondo, Color texto, Color boton, Color amarilloSec) {
		...
		JLabel lblGuardiasincumplidas = new JLabel("Guardias Incumplidas");
		lblGuardiasincumplidas.setFont(new Font("Arial", Font.BOLD, 16));
		panelSuperior.add(lblGuardiasincumplidas);
